    ...
    xhr.onreadystatechange=function(){
        if(xhr.status===200&&xhr.readyState===4){
            ...
            for(i=0;i<len;i++){
                ...
                newOption.innerText=data[i].CountryName;
    ...
    select1.ele.addEventListener("change",function(){
        change.call(this,5,select1,select2,'Provinces','ProvinceName');
    });
    select2.ele.addEventListener("change",function(){
        change.call(this,4,select2,select3,'Cities','CityName');
    });
    select3.ele.addEventListener("change",function(){
        change.call(this,3,select3,select4,'Areas','AreaName');
    });
    select4.ele.addEventListener("change",function(){
        change.call(this,2,select4,select5,'Zhens','ZhenName');
    });
    select5.ele.addEventListener("change",function(){
        change.call(this,1,select5,select6,'Cuns','CunName');
    });
    var textArr=["请选择村","请选择乡镇","请选择区县","请选择城市","请选择省份"];
